...
export function Toolbar() {
  ...
  return (
    <div className="hairline-t flex h-10 shrink-0 items-center gap-3 bg-panel px-3">
      {module === 'library' && (
        <SegmentedControl
          size="sm"
          options={viewOptions}
    ...
    <div className="flex items-center gap-0.5">
      {[1, 2, 3, 4, 5].map((n) => (
        <button
          ...
          className={cn(
            'p-0.5 transition-colors duration-[--duration-fast] disabled:opacity-25',
...
function ToolbarToggle({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'grid size-[22px] place-items-center rounded-[5px]',
...
function HdrToggle() {
  ...
  return (
    <button
      ...
      onClick={toggleHdr}
      className={cn(
        'h-[22px] rounded-[5px] px-1.5 text-micro font-medium tracking-[0.06em]',
        'transition-[background-color,color] duration-[--duration-fast] ease-[--ease-out]',
        'disabled:pointer-events-none disabled:opacity-25',
